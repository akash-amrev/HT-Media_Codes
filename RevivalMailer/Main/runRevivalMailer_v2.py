...
############-----------------  Summary of Script
#########################################################################################################
#--> For each candidate in 'candidates_processed' collection in 'mailer_weekly' database (172.22.66.233)
#    best matching jobs are calculated from a pool of jobs stored in 'jobs_processed'
#    collection in 'mailer_weekly' database.
...
#--> Final recommendation are stored in Mongo (172.22.66.233) in 'WeeklyMsgQueue' collection in 
#    'mailer_weekly' database.
...
#Custom Modules
from Features.CTCMatchScore.CTCMatchScore import CTCMatchScore      #Custom Module - /data/Projects/RevivalMailer/Features/CTCMatchScore/CTCMatchScore.py
from Features.ExpMatchScore.ExpMatchScore import ExpMatchScore      #Custom Module - /data/Projects/RevivalMailer/Features/ExpMatchScore/ExpMatchScore_v1.py
from Features.PaidBoostScore.PaidBoostScore import PaidBoostScore   #Custom Module - /data/Projects/RevivalMailer/Features/PaidBoostScore/PaidBoostScore.py
from Features.CityScore.getCityScore import CityMatch               #Custom Module - /data/Projects/RevivalMailer/Features/CityScore/getCityScore.py
from Model.getOverallMatchScore import getOverallMatchScore         #Custom Module - /data/Projects/RevivalMailer/Model/getOverallMatchScore.py
...
from Features.JobAlert_Functions import *                           #Custom Module - /data/Projects/RevivalMailer/Features/JobAlert_Functions.py
...
if __name__ == '__main__':
    ...
    try:
        ...
        ############-----------------  Start the timer
        #########################################################################################################
        send_email(['akash.verma@hindustantimes.com', 'kanika.khandelwal@hindustantimes.com'],"Revival Mailer Weekly",'Recommendations generation Started!!!')
        ...
        send_email(['akash.verma@hindustantimes.com', 'kanika.khandelwal@hindustantimes.com'],"Revival Mailer Weekly",'Recommendations generation Completed!!!')
        
    except:
        send_email(['akash.verma@hindustantimes.com', 'kanika.khandelwal@hindustantimes.com','progressiveht@hindustantimes.com'],"Revival Mailer Weekly - URGENT!!!","Recommendation Generation Failed !!!!\nCall Akash (+91-8527716555) or Kanika (+91-9560649296)")