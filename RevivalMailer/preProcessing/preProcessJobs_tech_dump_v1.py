...
def preProcessChunk(chunkID):
    ...
    send_email(['akash.verma@hindustantimes.com', 'kanika.khandelwal@hindustantimes.com'],"Revival Mailer Weekly",'TEch Dump Jobs Processed '+str(i)+' in :' + str(end_time - start_time) + ' seconds')
...
if __name__ == '__main__':
    ...
    #########################################################################################################
    try:
        send_email(['akash.verma@hindustantimes.com', 'kanika.khandelwal@hindustantimes.com'],"Revival Mailer Weekly","Jobs Processeing Tech Dump Started !!")
        ...
        send_email(['akash.verma@hindustantimes.com', 'kanika.khandelwal@hindustantimes.com','progressiveht@hindustantimes.com'],"Revival Mailer Weekly - URGENT!!!","Tech Dump Jobs Processing from SQL Failed!!!!!\nCall Akash (+91-8527716555) or Kanika (+91-9560649296) asap.")
