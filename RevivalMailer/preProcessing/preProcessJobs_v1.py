...
############-----------------  Summary of Script
#########################################################################################################
#--> This module provides functions for preProcessing Jobs for RevivalMailerWeekly.
#--> It connects to the SQL Server(172.16.66.204) and fetches Jobs of last 15 days.
...
from Utils.HtmlCleaner import HTMLStripper ,cleanHTML               #Custom Module - /data/Projects/RevivalMailer/Utils/HtmlCleaner.py
...
def preProcessChunk(chunkID):
    ...
    monconn_jobs_local = MongoConnect(tableName, host = 'localhost', database = 'mailer_weekly')
    ...
    send_email(['akash.verma@hindustantimes.com', 'kanika.khandelwal@hindustantimes.com'],"Revival Mailer Weekly",'Jobs Processed '+str(i)+' in :' + str(end_time - start_time) + ' seconds')
...
if __name__ == '__main__':
    ...
    #########################################################################################################
    try:
        send_email(['akash.verma@hindustantimes.com', 'kanika.khandelwal@hindustantimes.com'],"Revival Mailer Weekly","Jobs Processing from SQL Started!!!")
        ...
        send_email(['akash.verma@hindustantimes.com', 'kanika.khandelwal@hindustantimes.com','progressiveht@hindustantimes.com'],"Revival Mailer Weekly - URGENT!!!","Jobs Processing Failed !!!!\nCall Akash (+91-8527716555) or Kanika (+91-9560649296)")
