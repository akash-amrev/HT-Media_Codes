...
############-----------------  Summary of Script
#########################################################################################################
#--> Extract last 20 days Live Jobs from recruiter SQL (172.22.66.204), processing the fields, cleaning 
#    textual fields, creating Bag of Words and storing the final document as required by Tech team 
#    in 'JobDesc_weekly' collection in 'JobDescDB' database (172.22.66.233)
...
def preProcessChunk(chunkID):
    ...
    send_email(['akash.verma@hindustantimes.com', 'kanika.khandelwal@hindustantimes.com'],"Revival Monthly",'TEch Dump Jobs Processed '+str(i)+' in :' + str(end_time - start_time) + ' seconds')
...
if __name__ == '__main__':
    ...
    #########################################################################################################
    try:
        send_email(['akash.verma@hindustantimes.com', 'kanika.khandelwal@hindustantimes.com'],"Revival Monthly","Jobs Processeing Tech Dump Started !!")
        ...
        send_email(['akash.verma@hindustantimes.com', 'kanika.khandelwal@hindustantimes.com','progressiveht@hindustantimes.com'],"Revival Monthly - Urgent!!!","Tech Dump Jobs Processing from SQL Failed!!!!!\nCall Akash (+91-8527716555) or Kanika (+91-9560649296) asap.")
