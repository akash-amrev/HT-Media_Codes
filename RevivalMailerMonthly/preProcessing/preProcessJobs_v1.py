...
############-----------------  Summary of Script
#########################################################################################################
#--> This module provides functions for preProcessing Jobs for RevivalMailerMonthly.
...
from Notifier.Notifier import send_email
import csv
import time
...
def preProcessChunk(chunkID):
    ...
    monconn_jobs_local = MongoConnect(tableName, host = 'localhost', database = 'mailer_monthly')
    ...
    send_email(['akash.verma@hindustantimes.com', 'kanika.khandelwal@hindustantimes.com'],"Revival Monthly",'Jobs Processed '+str(i)+' in :' + str(end_time - start_time) + ' seconds')
...
if __name__ == '__main__':
    ...
    #########################################################################################################
    try:
        send_email(['akash.verma@hindustantimes.com', 'kanika.khandelwal@hindustantimes.com'],"Revival Monthly","Jobs Processing from SQL Started!!!")
        ...
        send_email(['akash.verma@hindustantimes.com', 'kanika.khandelwal@hindustantimes.com','progressiveht@hindustantimes.com'],"Revival Monthly - Urgent!!!","Jobs Processing from SQL Failed!!!!!\nCall Akash (+91-8527716555) or Kanika (+91-9560649296) asap.")
