...
############-----------------  Summary of Script
#################################################################################################################
#--> This module provides functions for preProcessing Jobs for MidoutMailer.
#--> It connects to the SQL Server(172.16.66.204) and fetches Jobs of last 7 days.
...
def preProcessChunk(chunkID):
    ...
    send_email(['akash.verma@hindustantimes.com', 'kanika.khandelwal@hindustantimes.com'],"Midout Mailers",'Jobs Processed '+str(i)+' in :' + str(end_time - start_time) + ' seconds')
    #os.system(' echo "Jobs Processed '+str(i)+' in :' + str(end_time - start_time) + ' seconds' +' " | mutt -s "Midout Mailers" ashish4669@gmail.com ,himanshusolanki53@gmail.com')
...
if __name__ == '__main__':
    ...
    #########################################################################################################
    try:
        send_email(['akash.verma@hindustantimes.com', 'kanika.khandelwal@hindustantimes.com'],"Midout Mailers","Jobs Processeing Started !!")
       ...
       send_email(['akash.verma@hindustantimes.com', 'kanika.khandelwal@hindustantimes.com','progressiveht@hindustantimes.com'],"Midout Mailers -Urgent!!!","Jobs Processing from SQL Failed!!!!!\nCall Akash (+91-8527716555) or Kanika (+91-9560649296) asap.")