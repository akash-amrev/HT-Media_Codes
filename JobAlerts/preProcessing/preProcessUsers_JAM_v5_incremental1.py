...
try:
    ...
    try:
        ...
        SOLR_URL_NEW = 'http://172.22.65.244:8989/solr/cda6m/select/?wt=json&rows=1000&q=*:*'
    except:
        SOLR_URL_NEW = 'http://172.22.65.156:8989/solr/cda/select/?wt=json&rows=1000&q=*:*'
    query="&fq=sEAS:(1%203)&fq=sPSS:0&fq=sPBS:0&fq=sLH:[NOW/DAY-4DAY TO *]"
    ...
    monconn_applies = MongoConnect(tablename, host='172.22.66.198', database='JobAlerts')
