...
#--> It connects to the SQL Server(172.16.66.64) and fetches Jobs of last 3 months.
...
def preProcessChunk(chunkID):
    ...
    cmd4='''SELECT
         ...
         (select * from recruiter_job 
            ...
            and (DATEDIFF( CURDATE(),DATE(recruiter_job.publisheddate)) < 93 OR DATEDIFF( CURDATE(),DATE(recruiter_job.republisheddate)) < 93)  
         ) AS rj 
    ...
    send_email(['akash.verma@hindustantimes.com', 'kanika.khandelwal@hindustantimes.com'],"SJ Onsite",'3 Month Jobs Processed '+str(i)+' in :' + str(end_time - start_time) + ' seconds')
    #os.system(' echo "3 Month Jobs Processed '+str(i)+' in :' + str(end_time - start_time) + ' seconds' +' " | mutt -s "Similar Jobs OnSite" ashish4669@gmail.com ,himanshusolanki53@gmail.com')
...
if __name__ == '__main__':
    ...
    try:
        send_email(['akash.verma@hindustantimes.com', 'kanika.khandelwal@hindustantimes.com'],"SJ Onsite","3 Months Jobs Processeing Started !!")
        ...
        send_email(['akash.verma@hindustantimes.com', 'kanika.khandelwal@hindustantimes.com','progressiveht@hindustantimes.com'],"Urgent!!!","SJ Onsite : 3 Months Jobs Processing from SQL Failed!!!!!\nCall Kanika (+91-9560649296) or Akash (+91-8527716555)   asap.")
