...
def main():
	...
	run_sas_query('/data/Analytics/Utils/MarketingReports/Model/SASCode/getSprinklerDataIncTemp_modified.sas', '/data/Analytics/Utils/MarketingReports/log/getSprinklerDataInc_'+str(previousDate)+'.log')
