/* Previous Version - v08
 * 
 * This Version - Nphase1ModifiedProfilesSimilarityUpdate rename from SimUpdNPhase1
 * 				- NPhase1NewProfilesSimilarityUpdate - Run to include the new profile similarity values for existing U1's 
 * 				- NPhase1ModifiedProfilesSimilarityUpdate - Run to include the modified profile similarity values for existing U1's
 * 				- NPhase2Partioner to process partition outputs from NPhase1, NPhase1NewProfilesSimilarityUpdate and NPhase1ModifiedProfilesSimilarityUpdate 
 * 								(No Change required comma seperated inputs will work fine for multiple input case)   
 * 
 */
...
public class NPhase1 extends Configured implements Tool {
	...
	public static final Log LOG = LogFactory.getLog(NPhase1.class);
	...
	public static void main(String[] args) throws Exception {
		System.out.println("NPhase1 Run Started ...");
		LOG.info("NPhase1 Run Started ...");
