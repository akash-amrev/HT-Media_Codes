 ...
 * 
 * This Version - Similarity Weightage FA wise added to R as a 2D array
 * 				- Logging
 * 				- Weighted Cutoff ( Min Profiles Attributes similarity to skip Skill similarity) 
 * 				- NPhase2 change - Sim Values scaled to 1000 and Output is "," seperated
 * 				- Input Output split based on ","
 * 				- FA as part of Output of Nphase1 and NPhase2
 * 				- Added NPhase2Partitioner to get Output segregated FA wise
 * 				- Exception Handling
 */
 ...
 */
public class NPhase1_v06 extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		String weightSim = "";
		JobConf conf = new JobConf(getConf(), NPhase1_v06.class);
	...
	public static void main(String[] args) throws Exception {
		...
		int res = ToolRunner.run(new Configuration(), new NPhase1_v06(), args);
		System.exit(res);
	}
} // NPhase1