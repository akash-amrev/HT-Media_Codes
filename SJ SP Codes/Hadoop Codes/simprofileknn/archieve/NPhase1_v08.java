/* Previous Version - v07
 * 
 * This Version - SimUpdNPhase1.java added to calculated updated similarity values for U1 and U2 based on U2's profile modification and New U2's to be added to U1's
 * 				- NPhase1 map input data with split with "|" OR "," (MySQL export)
 */
 ...
 */
public class NPhase1_v08 extends Configured implements Tool {

	public static final Log LOG = LogFactory.getLog(NPhase1_v08.class);
	...
	public int run(String[] args) throws Exception {
		...
		String weightSim = "";
		JobConf conf = new JobConf(getConf(), NPhase1_v08.class);
	...
	public static void main(String[] args) throws Exception {
		...
		int res = ToolRunner.run(new Configuration(), new NPhase1_v08(), args);
		System.exit(res);
	}
} // NPhase1