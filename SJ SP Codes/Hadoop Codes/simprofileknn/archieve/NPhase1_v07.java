/* Previous Version - v06
 * 
 * This Version - Apache Logging
 * 				- NPhase2Partioner with input and output in LookUp
 * 				- NPhase2PartionerUserId with input as LookUp and output as UserId
 * 				- NPhase2PartitionerLookUp with input as UserId and output as LookUp
 */
 ...
 */
public class NPhase1_v07 extends Configured implements Tool {

	public static final Log LOG = LogFactory.getLog(NPhase1_v07.class);
	...
	public int run(String[] args) throws Exception {
		...
		String weightSim = "";
		JobConf conf = new JobConf(getConf(), NPhase1_v07.class);
	...
	public static void main(String[] args) throws Exception {
		...
		int res = ToolRunner.run(new Configuration(), new NPhase1_v07(), args);
		System.exit(res);
	}
} // NPhase1