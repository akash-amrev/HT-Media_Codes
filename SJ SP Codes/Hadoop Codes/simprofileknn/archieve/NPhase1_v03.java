 ...
 */
public class NPhase1_v03 extends Configured implements Tool {
				...
				while (true) {
					...
					for (int i = 0; i < number; i++) {
						...
						if (denominator == 0 && dotProduct == 0) {
							...
							simval = dotProduct / denominator;
						}

						simval = (float) Math.pow(simval, 4);
	...
	public int run(String[] args) throws Exception {
		...
		JobConf conf = new JobConf(getConf(), NPhase1_v03.class);
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new NPhase1_v03(), args);
		System.exit(res);
	}
} // NPhase1