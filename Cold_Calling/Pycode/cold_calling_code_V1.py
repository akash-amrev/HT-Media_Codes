...
if __name__ == '__main__':
    ...
    df_cold_calling_scoring = pd.read_csv('/data/Projects/Cold_Calling/Output_Files/cold_calling_file.csv')	
    df_cold_calling_scoring['user_experience'] = df_cold_calling_scoring['user_experience'].fillna(0)
    print df_cold_calling_scoring.head(4)
    sys.exit(0)
    ...
    if weekday == 'Saturday':
        ...
        df_concentrix.to_csv('/data/Projects/Cold_Calling/Output_Files/concentrix_leads_' +str(todayDate) +'.csv',index = False)
    ...
    if weekday == 'Saturday':
        ...
        #print df_final.count()
        df_ktech.to_csv('/data/Projects/Cold_Calling/Output_Files/ktech_leads_' +str(todayDate) +'.csv',index = False)
        ktech_file = '/data/Projects/Cold_Calling/Output_Files/ktech_leads_' +str(todayDate) +'.csv'
        print ktech_file
        command = 'mutt -s "KTech Leads" sidharth.gupta1@hindustantimes.com ,akash.verma@hindustantimes.com -a %s'% ktech_file
        print command
        os.system(command)
        
        df_final.to_csv('/data/Projects/Cold_Calling/Output_Files/cold_calling_leads_v2.csv',index = False)
        cold_calling_temp_file = '/data/Projects/Cold_Calling/Output_Files/cold_calling_leads_v2.csv'
        os.system('mutt -s "KTech Leads" F2527@htmedia.in,karminder.kaur@hindustantimes.com,sidharth.gupta1@hindustantimes.com,vinod.kumar2@hindustantimes.com,akash.verma@hindustantimes.com -a %s'%cold_calling_temp_file)
