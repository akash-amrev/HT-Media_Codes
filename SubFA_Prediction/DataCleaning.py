...
#############################################################################################################
#stop = []
stop = [u'i', u'me', u'my', u'myself', u'we', u'our', u'ours', u'ourselves', u'you', u'your', u'yours', u'yourself', u'yourselves', u'he', u'him', u'his', u'himself', u'she', u'her', u'hers',
        u'herself', u'it', u'its', u'itself', u'they', u'them', u'their', u'theirs', u'themselves', u'what', u'which', u'who', u'whom', u'this', u'that', u'these', u'those', u'am', u'is', u'are', u'was', u'were', u'be', u'been', u'being', u'have', u'has', u'had', u'having', u'do', u'does', u'did', u'doing', u'a', u'an', u'the', u'and', u'but', u'if', u'or', u'because', u'as', u'until', u'while', u'of', u'at', u'by', u'for', u'with', u'about', u'against', u'between', u'into', u'through', u'during', u'before', u'after', u'above', u'below', u'to', u'from',
        u'up', u'down', u'in', u'out', u'on', u'off', u'over', u'under', u'again', u'further', u'then', u'once', u'here', u'there', u'when', u'where', u'why', u'how', u'all', u'any', u'both',
        u'each', u'few', u'more', u'most', u'other', u'some', u'such', u'no', u'nor', u'not', u'only', u'own', u'same', u'so', u'than', u'too', u'very', u's', u't', u'can', u'will', u'just', 
        u'don', u'should', u'now', u'd', u'll', u'm', u'o', u're', u've', u'y', u'ain', u'aren', u'couldn', u'didn', u'doesn', u'hadn', u'hasn', u'haven', u'isn', u'ma', u'mightn', u'mustn', u'needn', u'shan', u'shouldn', u'wasn', u'weren', u'won', u'wouldn']
#stop = stopwords.words('english')
fin = open("../InputFiles/stopwords.csv")
reader = csv.reader(fin)
for row in reader:
...
#############################################################################################################
fin = open('../InputFiles/taxonomy_v1.csv', 'rb')
reader = csv.reader(fin)
...
#############################################################################################################
##########---------- Creating Other Spelling Correction Dicts
#############################################################################################################
fin = open('../InputFiles/taxonomy_v2.csv', 'r')
reader = csv.reader(fin)

taxonomy_dict_1 = {}
taxonomy_dict_2 = {}
taxonomy_dict_2_text = ''
for row in reader:
    if len(row[0].split()) == 1:
        taxonomy_dict_1[row[0].strip().lower()] = row[1].strip().lower()
    else:
        taxonomy_dict_2[row[0].strip().lower()] = row[1].strip().lower()
        taxonomy_dict_2_text = taxonomy_dict_2_text + row[0].strip().lower() + ' '

taxonomy_dict_1_keys = taxonomy_dict_1.keys()
taxonomy_dict_2_keys = list(set(taxonomy_dict_2_text.split()))
...
def replace_abbr(data):
    ...
    data = data.replace('c++', " cplusplus ").replace('+', "+ ").replace("..", ".").replace("..", ".").replace(".", ". ").replace(",", ", ").replace("_", "_ ").replace("c#", "csharp ").replace("&", " & ")
...
def spell_corrector(data):
    ...
    if len(set(new_text).intersection(taxonomy_dict_1_keys)) > 0:
        data = ' '.join([taxonomy_dict_1[i] if i in taxonomy_dict_1_keys else i for i in data.split()])
    
    new_text = data.split()
    if len(set(new_text).intersection(taxonomy_dict_2_keys)) > 0:
        for key in taxonomy_dict_2:
            data = re.sub('^(' + key +') ', taxonomy_dict_2[key] + ' ', data)
            data = re.sub(' (' + key +')$', ' ' + taxonomy_dict_2[key], data)
            data = re.sub(' (' + key +') ', ' ' + taxonomy_dict_2[key] + ' ', data)
